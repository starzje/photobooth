        ...
        <div className="py-12 md:py-20">
          ...
          <div
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h3 className="h4 font-playfair-display mb-2">Personalizirane uspomene</h3>
              <p className="text-lg text-slate-500">
                Photobooth pruža gostima personalizirane uspomene s događaja u obliku printane fotografije
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="100">
              ...
              <h3 className="h4 font-playfair-display mb-2">Zabava za sve uzraste</h3>
              <p className="text-lg text-slate-500">
                Photobooth nudi zabavnu aktivnost za sve goste na događaju, bez obzira na njihovu dob
              </p>
            </div>
