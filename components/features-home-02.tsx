    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div id="o-nama" className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-800">Više o nama</h2>
          </div>
          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-start md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
            ...
            <div className="md:w-7/12 lg:w-1/2" data-aos="fade-up">
              <div className="mb-8 text-center md:text-left">
                <h3 className="h3 text-slate-800 font-playfair-display mb-3">Dugogodišnje iskustvo</h3>
                <p className="text-xl text-slate-500">
                  Naša priča započinje prije više od desetljeća kao foto video studio F.M.I., s vizijom stvaranja
                  nezaboravnih trenutaka kroz jedinstvene fotografske doživljaje. Od samih početaka, naš fokus bio je na
                  pružanju izvrsne usluge, inovativnosti i stvaranju trajnih uspomena.
                </p>
              </div>
              {/* Tabs buttons */}
